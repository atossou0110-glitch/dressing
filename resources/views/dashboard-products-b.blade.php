    ...
    <x-slot:header>
        <div class="admin-page-header">
            <div>
                ...
                <h1 class="admin-title mt-3">Produit B</h1>
                <p class="admin-copy mt-3 max-w-3xl">
                    Page dédiée à l'édition du produit B, avec la même logique de présentation que le storefront et le dashboard principal.
                </p>
            </div>
        ...
        <section class="admin-surface admin-surface-muted px-6 py-6 sm:px-8">
            <div class="grid gap-4 md:grid-cols-3">
                ...
                <article class="admin-stat-card">
                    ...
                    <p class="admin-stat-copy mt-3">État actuel du produit B côté administration.</p>
                </article>

                <article class="admin-stat-card">
                    <p class="admin-stat-label">Avis</p>
                    <p class="admin-stat-value mt-4">{{ (int) ($product->reviews_count ?? 0) }}</p>
                    <p class="admin-stat-copy mt-3">Commentaires visibles liés au produit B.</p>
                </article>
            </div>
        </section>
        ...
        <section class="admin-surface px-6 py-6 sm:px-8">
            <div class="admin-page-header">
                <div>
                    ...
                    <h2 class="mt-3 text-2xl font-semibold text-[var(--brand-ink)]">Contenu public du produit B</h2>
                </div>
